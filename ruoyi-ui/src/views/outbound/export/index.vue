<template>
  <div class="app-container">
    <el-form :model="queryParams" ref="queryForm" size="small" :inline="true" v-show="showSearch" >
      <el-form-item label="机器人名称" prop="bizName">
        <el-input
    ...
    <el-table v-loading="loading" :data="exportList" @selection-change="handleSelectionChange">
      <el-table-column label="机器人名称" align="center" prop="bizName" />
      <el-table-column label="业务描述" align="center" prop="desc" />
      ...
      <el-table-column label="操作" align="center" class-name="small-padding fixed-width">
        <template slot-scope="scope">
          <el-button
            ...
            v-hasPermi="['outbound:export:edit']"
          >定制逻辑</el-button>
        </template>
      </el-table-column>
    </el-table>
    ...
    <!-- 添加或修改机器人标签管理对话框 -->
    <typelist ref="typelist" v-show="open"></typelist>
  </div>
</template>

<script>
import { listExport, getExport, delExport, addExport, updateExport } from "@/api/outbound/export";
...
export default {
  ...
  methods: {
    ...
    handleUpdate(row) {
      this.open = true;
      this.$refs.typelist.getExportlist(row)
    },
    /** 提交按钮 */
    submitForm() {
